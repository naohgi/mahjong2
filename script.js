...
//// 関数
    ...
    // ハイの表示更新
    function updateViewOfHai(hais, place) {
        let haiElementTemplete = place.innerHTML;
        place.innerHTML = "";
        hais.forEach(
            function (hai) {
                place.innerHTML += haiElementTemplete
...
window.addEventListener('load', function () {
    ...
    // 手牌と山ハイと河ハイの表示更新
    {
        updateViewOfHai(teHai, te);
        updateViewOfHai(yamaHai, yama);
        updateViewOfHai([],kawa);
    }

    // 手牌選択時の処理
    te.getElementsByClassName("hai").addEventListener('click',
        function(){
            kawa.push(
                {
                    id:this.getPropercv
